...
#ifndef PROTOBUF_client_5fmsg_2fsensor_2fsensor_5fremove_2eproto__INCLUDED
#define PROTOBUF_client_5fmsg_2fsensor_2fsensor_5fremove_2eproto__INCLUDED
...
class Remove : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:external.client.sensor.Remove) */ {
 public:
  Remove();
  virtual ~Remove();
  ...
  // @@protoc_insertion_point(class_scope:external.client.sensor.Remove)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::external::client::Sensor > sensor_;
  mutable int _cached_size_;
  friend struct protobuf_client_5fmsg_2fsensor_2fsensor_5fremove_2eproto::TableStruct;
};
// ===================================================================
...
// repeated .external.client.Sensor sensor = 1;
inline int Remove::sensor_size() const {
  return sensor_.size();
}
inline void Remove::clear_sensor() {
  sensor_.Clear();
}
inline const ::external::client::Sensor& Remove::sensor(int index) const {
  // @@protoc_insertion_point(field_get:external.client.sensor.Remove.sensor)
  return sensor_.Get(index);
}
inline ::external::client::Sensor* Remove::mutable_sensor(int index) {
  // @@protoc_insertion_point(field_mutable:external.client.sensor.Remove.sensor)
  return sensor_.Mutable(index);
}
inline ::external::client::Sensor* Remove::add_sensor() {
...
#endif  // PROTOBUF_client_5fmsg_2fsensor_2fsensor_5fremove_2eproto__INCLUDED
