...
#ifndef PROTOBUF_client_5fmsg_2fgeolocation_2fgeo_5fstatistic_2eproto__INCLUDED
#define PROTOBUF_client_5fmsg_2fgeolocation_2fgeo_5fstatistic_2eproto__INCLUDED
...
class Statistic_Item : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:external.client.geolocation.Statistic.Item) */ {
 public:
  Statistic_Item();
  ...
  ::external::client::geolocation::Statistic_State state() const;
  void set_state(::external::client::geolocation::Statistic_State value);

  // @@protoc_insertion_point(class_scope:external.client.geolocation.Statistic.Item)
 private:
  ...
  friend struct protobuf_client_5fmsg_2fgeolocation_2fgeo_5fstatistic_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Statistic : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:external.client.geolocation.Statistic) */ {
 public:
  Statistic();
  virtual ~Statistic();
  ...
  const ::external::client::geolocation::Statistic_Item& item(int index) const;
  ::external::client::geolocation::Statistic_Item* mutable_item(int index);
  ::external::client::geolocation::Statistic_Item* add_item();
  ...
  // @@protoc_insertion_point(class_scope:external.client.geolocation.Statistic)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::external::client::geolocation::Statistic_Item > item_;
  mutable int _cached_size_;
  friend struct protobuf_client_5fmsg_2fgeolocation_2fgeo_5fstatistic_2eproto::TableStruct;
};
// ===================================================================
...
inline ::external::client::geolocation::Statistic_State Statistic_Item::state() const {
...
inline void Statistic_Item::set_state(::external::client::geolocation::Statistic_State value) {
...
inline const ::external::client::geolocation::Statistic_Item& Statistic::item(int index) const {
  // @@protoc_insertion_point(field_get:external.client.geolocation.Statistic.item)
  return item_.Get(index);
}
inline ::external::client::geolocation::Statistic_Item* Statistic::mutable_item(int index) {
  // @@protoc_insertion_point(field_mutable:external.client.geolocation.Statistic.item)
  return item_.Mutable(index);
}
inline ::external::client::geolocation::Statistic_Item* Statistic::add_item() {
  // @@protoc_insertion_point(field_add:external.client.geolocation.Statistic.item)
  return item_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::external::client::geolocation::Statistic_Item >*
Statistic::mutable_item() {
  // @@protoc_insertion_point(field_mutable_list:external.client.geolocation.Statistic.item)
  return &item_;
}
inline const ::google::protobuf::RepeatedPtrField< ::external::client::geolocation::Statistic_Item >&
...
template <> struct is_proto_enum< ::external::client::geolocation::Statistic_State> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::external::client::geolocation::Statistic_State>() {
  return ::external::client::geolocation::Statistic_State_descriptor();
}
...
#endif  // PROTOBUF_client_5fmsg_2fgeolocation_2fgeo_5fstatistic_2eproto__INCLUDED
